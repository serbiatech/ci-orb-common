...
lint:
	/bin/bash /home/sphere-master/local-execute.sh ${LINT_JOB} ${LINT_OPTIONS_REPLACE}

pack:
	/bin/bash /home/sphere-master/local-execute.sh ${PACK_JOB}

shellcheck:
	/bin/bash /home/sphere-master/local-execute.sh ${SHELLCHECK_JOB}

bats:
	/bin/bash /home/sphere-master/local-execute.sh ${BATS_JOB}

local-execute:
	/bin/bash /home/sphere-master/local-execute.sh $(job) $(optionsReplace)
